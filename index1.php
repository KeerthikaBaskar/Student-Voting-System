...
<body>
    <div class="parent">
        ...
        <div class="container">
            <a class="gradient" href="registerVoter.php"><i class="fas fa-user-plus"></i> Voter Registration</a>
            <a class="gradient" href="voterLogin.php"><i class="fas fa-sign-in-alt"></i> Voter Login</a>
            <a class="gradient" href="registerCandidate.php"><i class="fas fa-user-tie"></i> Candidate Registration</a>
            <a class="gradient" href="adminLogin.php"><i class="fas fa-user-shield"></i> Admin Login</a>
